...
inline constexpr Preset kPresets[] = {
    ...
    { "Vocal Singing", 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 0.0f, -10.0f, 50.0f,  1000.0f, 15.0f, -60.0f,  5.0f, 150.0f, -50.0f, 2.0f, 15.0f, 25.0f, 6.0f, -20.0f, 3.5f, 15.0f, 200.0f, 0.0f, 1.0f, -1.0f, 5.0f, 100.0f }
};
